...
call msbuild.exe .\Libraries\CANAPI\uvcankvl.vcxproj /t:Clean;Build /p:"Configuration=Release_lib";"Platform=Win32"
if errorlevel 1 goto end
...
call msbuild.exe .\Libraries\KvaserCAN\KvaserCAN.vcxproj /t:Clean;Build /p:"Configuration=Release_lib";"Platform=Win32"
if errorlevel 1 goto end
...
copy /Y .\Libraries\CANAPI\Release_dll\u3cankvl.exp %BIN%
copy /Y .\Libraries\CANAPI\Release_dll\u3cankvl.lib %BIN%
copy /Y .\Libraries\CANAPI\Release_dll\u3cankvl.pdb %BIN%
copy /Y .\Libraries\KvaserCAN\Release_dll\uvKvaserCAN.dll %BIN%
copy /Y .\Libraries\KvaserCAN\Release_dll\uvKvaserCAN.exp %BIN%
copy /Y .\Libraries\KvaserCAN\Release_dll\uvKvaserCAN.lib %BIN%
copy /Y .\Libraries\KvaserCAN\Release_dll\uvKvaserCAN.pdb %BIN%
set BIN=%BIN%\lib
if not exist %BIN% mkdir %BIN%
echo Copying static libraries...
copy /Y .\Libraries\CANAPI\Release_lib\u3cankvl.lib %BIN%
copy /Y .\Libraries\CANAPI\Release_lib\u3cankvl.pdb %BIN%
copy /Y .\Libraries\KvaserCAN\Release_lib\uvKvaserCAN.lib %BIN%
copy /Y .\Libraries\KvaserCAN\Release_lib\uvKvaserCAN.pdb %BIN%
