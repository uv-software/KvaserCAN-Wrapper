...
//static const char* __copyright__ = "Copyright (C) 2017 by UV Software, Berlin";
...
#define BITRATE_DEFAULT		"f_clock_mhz=80,nom_brp=8,nom_tseg1=31,nom_tseg2=8,nom_sjw=8,data_brp=2,data_tseg1=15,data_tseg2=4,data_sjw=2"
#define BITRATE_125K1M		"f_clock_mhz=80,nom_brp=4,nom_tseg1=127,nom_tseg2=32,nom_sjw=8,data_brp=2,data_tseg1=31,data_tseg2=8,data_sjw=2"
#define BITRATE_250K2M		"f_clock_mhz=80,nom_brp=2,nom_tseg1=127,nom_tseg2=32,nom_sjw=8,data_brp=2,data_tseg1=15,data_tseg2=4,data_sjw=2"
 ...
 */
{
	...
	for(i = 1; i < argc; i++) {
		/* Kvaser CAN channel */
		if(!strcmp(argv[i], "Kvaser CAN Channel 8") || !strcmp(argv[i], "CH8")) channel = KVASER_CAN_CHANNEL0;
