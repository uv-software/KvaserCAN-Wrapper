...
echo  * >> .\Sources\build_no.h
echo  *  Copyright (c) 2017-2024 Uwe Vogt, UV Software, Berlin (info@uv-software.com) >> .\Sources\build_no.h
echo  *  All rights reserved. >> .\Sources\build_no.h
echo  * >> .\Sources\build_no.h
echo  *  This file is part of KvaserCAN-Wrapper. >> .\Sources\build_no.h
echo  * >> .\Sources\build_no.h
echo  *  KvaserCAN-Wrapper is dual-licensed under the BSD 2-Clause "Simplified" License >> .\Sources\build_no.h
echo  *  and under the GNU General Public License v3.0 (or any later version). You can >> .\Sources\build_no.h
echo  *  choose between one of them if you use KvaserCAN-Wrapper in whole or in part. >> .\Sources\build_no.h
echo  * >> .\Sources\build_no.h
...
echo  * >> .\Sources\build_no.h
echo  *  KvaserCAN-Wrapper IS PROVIDED BY THE COPYRIGHT HOLDERS AND CONTRIBUTORS "AS IS" >> .\Sources\build_no.h
...
echo  *  OF KvaserCAN-Wrapper, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGE. >> .\Sources\build_no.h
echo  * >> .\Sources\build_no.h
...
echo  *  along with KvaserCAN-Wrapper.  If not, see "https://www.gnu.org/licenses/". >> .\Sources\build_no.h
echo  */ >> .\Sources\build_no.h
